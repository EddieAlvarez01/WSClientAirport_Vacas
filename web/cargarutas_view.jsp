<%-- 
    Document   : cargarutas_view
    Created on : 7/07/2019, 07:17:17 PM
    Author     : Eddie
--%>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="modificar_ruta.html" aria-expanded="false"><i class="mdi mdi-airplane"></i><span class="hide-menu">Modificar Ruta</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="eliminar_ruta.html" aria-expanded="false"><i class="mdi mdi-airplane-off"></i><span class="hide-menu">Eliminar ruta</span></a></li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Cargar Rutas</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <form action="ServiceInsertRoute" method="POST" enctype="multipart/form-data">
                                       <input type="file" id="file-input" name="inputRoute">
